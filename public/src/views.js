      ...
      <article class=app>
        <nav class=routes>
          <ul>
            ...
            <li><a href=${location.pathname == '/runtests.html' ? '/>Normal' : '/runtests.html>Test'}</a>
            <li><a target=_blank href=https://github.com/cris691/websocket_chat_app_homework>GitHub</a>
          </ul>
        </nav>
        ${currentView(state)}
      </article>
